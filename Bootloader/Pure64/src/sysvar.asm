...
cfg_vesa:		db 0	; By default VESA is disabled. Activamos VESA para poder utilizar el driver de video.
...
VBEModeInfoBlock:	equ 0x0000000000005C00	; 256 bytes // ACA ESTÁ LA DATA DEL VIDEO
